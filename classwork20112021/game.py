...
for level in levelList:
    if level == 0:
        ...
        print("В зале находится монстр силой", monster.power(), "очков.")
        ...
        print("В зале лежит артефакт силой", artefact.power(), "очков.")
        hero.buf(artefact.power())

print("Герой прошел все залы с силой", hero.power())